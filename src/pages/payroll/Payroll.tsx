                    ...
                    <div className=' relative w-[47%] rounded-2xl p-3 overflow-visible scrollbar-hide h-[72vh] pt-11'>
                        ...
                        <div className='bg-[#E2E2DE] shadow-0px_0px_15px_0px_[#C3C7C64D] rounded-2xl p-3'>
                            <div className='flex justify-between'>
                                <h1 style={{...FONTS.payroll_head,color:COLORS.primary}}>Pervious Slip</h1>
                                <img src={DownloadIcon} alt="" className='w-[25px] h-[25px]'/>
                            </div>

                            <div className='mt-4 flex justify-between gap-6'>
                                <section className='bg-[#EAEBE8] p-3 rounded-lg flex justify-between w-full'>
                        ...
                        <div className='bg-[#E2E2DE] shadow-0px_0px_15px_0px_[#C3C7C64D] rounded-2xl p-3 mt-6'>
                            {/* <div className='flex justify-between'> */}
                            ...
                            <div className='mt-4 flex justify-between gap-6'>
                                ...
                                <input style={{...FONTS.Nav,color:COLORS.primary}} type="text" className='bg-[#EAEBE8] p-3 rounded-lg flex justify-between w-full border border-[#4A7079] outline-0' placeholder='No.of.Worked Days'/>
                                <section className='bg-[#EAEBE8] p-3 rounded-lg flex justify-between w-full'>
                                    <p style={{...FONTS.Nav,color:COLORS.primary}}>Absent</p>
                                    <p style={{...FONTS.Nav,color:COLORS.primary}}>10</p>
                                </section>
