                        ...
                        <div className="flex flex-col w-full gap-10">
                            <div className="grid grid-cols-2 gap-5 w-full">
                                ...
                                <div className="w-full bg-[#EAEBE8] shadow-[0px_0px_15px_0px_#4A70791A] p-4 flex flex-col gap-5 rounded-xl">
                                    <h1 style={{ ...FONTS.table_head }} className='text-[#4A7079] !text-[12px] !font-bold'>Organsation Name:</h1>
                                    <h1 style={{ ...FONTS.table_data }} className='text-[#4A7079] !text-[10px] !font-medium break-words'>{company_details?.company_name}</h1>
                                </div>
                                <div className="w-full bg-[#EAEBE8] shadow-[0px_0px_15px_0px_#4A70791A] p-4 flex flex-col gap-5 rounded-xl">
                                    <h1 style={{ ...FONTS.table_head }} className='text-[#4A7079] !text-[12px] !font-bold'>Organsation Mail:</h1>
                                    <h1 style={{ ...FONTS.table_data }} className='text-[#4A7079] !text-[10px] !font-medium break-words'>{company_details?.contact_info?.email}</h1>
                                </div>
                                <div className="w-full bg-[#EAEBE8] shadow-[0px_0px_15px_0px_#4A70791A] p-4 flex flex-col gap-5 rounded-xl">
                                    <h1 style={{ ...FONTS.table_head }} className='text-[#4A7079] !text-[12px] !font-bold'>Organsation Phone:</h1>
                                    <h1 style={{ ...FONTS.table_data }} className='text-[#4A7079] !text-[10px] !font-medium break-words'>{company_details?.contact_info?.phone}</h1>
                                </div>
                            </div>
                        </div>
                        <div className="w-full bg-[#EAEBE8] shadow-[0px_0px_15px_0px_#4A70791A] p-4 flex flex-col gap-5 rounded-xl">
                            <h1 style={{ ...FONTS.table_head }} className='text-[#4A7079] !text-[12px] !font-bold'>Organsation Address:</h1>
                            <h1 style={{ ...FONTS.table_data }} className='text-[#4A7079] !text-[10px] !font-medium break-words'>{company_details?.contact_info?.address}</h1>
                        </div>
                    </>)
                    :
                    (<>
